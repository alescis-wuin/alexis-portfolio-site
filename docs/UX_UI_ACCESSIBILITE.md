...
- Scroll naturel conservé ; la navigation section par section reste disponible par liens, flèches et clavier.
...
- Respect de `prefers-reduced-motion` pour les animations et le scroll.
...
- Les améliorations UI/UX actives sont intégrées dans `index.html`, `styles.css` et `main.js`.
